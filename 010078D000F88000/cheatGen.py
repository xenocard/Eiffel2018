...
AddCheatCode(
    ...
    PointerCodeArithmetic('+','F','F',offset2+0x681) +
...
AddCheatCode(
    ...
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x682) +
...
AddCheatCode(
    ...
    PointerCodeArithmetic('','D','D',offset1) +
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x683) +
...
AddCheatCode(
    ...
    PointerCodeArithmetic('','D','D',offset1) +
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x684) +
...
AddCheatCode(
    ...
    PointerCodeArithmetic('','D','D',offset1) +
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x685) +
...
AddCheatCode(
    ...
    PointerCodeArithmetic('','D','D',offset1) +
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x686) +
...
AddCheatCode(
    ...
    PointerCodeArithmetic('','D','D',offset1) +
    PointerCodeHeader(savedata,'F') +
    PointerCodeArithmetic('+','F','F',offset2+0x687) +
...
AddCheatCode('n[Credit to @patjenova httpsgbatemp.netthreadscheat-codes-ams-and-sx-os-add-and-request.520293post-9494090]n20000000')
